 ...
 * @return
 */
public class CommentListMain extends BaseActivity implements OnClickListener {
	...
	new AsyncTask<String, Void, ArrayList<HashMap<String, String>>>() {
		...
		try {
			...
			hashMap.put("pjzs", _data.getString("pjzs"));
			hashMap.put("hpzs", _data.getString("hpzs"));
			hashMap.put("zpzs", _data.getString("zpzs"));
			hashMap.put("cpzs", _data.getString("cpzs"));
...
//		all.setText("(" + map.get("pjzs") + ")");
//		good.setText("(" + map.get("hpzs") + ")");
//		medium.setText("(" + map.get("zpzs") + ")");
//		bad.setText("(" + map.get("cpzs") + ")");
		break;
